...
namespace KymiraAdmin.Controllers
{
    public class SitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("siteID,address,frequency,pickupDays")] Site site)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("siteID,address,frequency,pickupDays")] Site site)
        {
            if (id != site.siteID)
            {
                return NotFound();
