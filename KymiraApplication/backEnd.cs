...
namespace KymiraApplication
{
    public class backEnd
    {
        ...
        public backEnd()
        {
            ...
            //bin1.collectionDate1 = "1/11/2019";
            //bin1.collectionDate2 = "1/20/2019";
        ...
        public String displayDate(BinCollectionDate bin)
        {
            for (int i = 0; i < binArray.Length; i++)
            {
                if (binArray[i].Address.Equals(bin.Address))
                {
                    ...
                    {
                        return (binArray[0].collectionDate1 + " & the next week date is " + binArray[0].collectionDate2);
                    }
                    else
                    {
